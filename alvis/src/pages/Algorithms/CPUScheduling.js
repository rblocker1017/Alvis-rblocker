...
export function fcfs(processes) {
  ...
  processList.forEach(function (i) {
    ...
    answer.push([
      ...
      i.name,
      i.name,
      new Date(0, 0, 0, 0, 0, timeCounter),
      new Date(0, 0, 0, 0, 0, timeCounter + i.burstTime),
      null,
      100,
      null,
    ]);
  ...
  return {
    ...
    waitingTime: (totalWaiting / processList.length).toFixed(2),
  };
}
...
export function roundRobin(processes, quantum) {
      ...
      if (i.arrivalTime <= timeCounter) {
        ...
        if (i.burstTime > parseInt(quantum)) {
          ...
          answer.push([
            ...
            i.name,
            new Date(0, 0, 0, 0, 0, timeCounter),
            new Date(0, 0, 0, 0, 0, timeCounter + parseInt(quantum)),
            null,
            100,
            null,
          ]);
  ...
  return {
    answer: answer,
    turnaroundTime: totalTat / processList.length,
    waitingTime: totalWaiting / processList.length,
  };
}
...
export function priorityFuncPreemptive(processes) {
  ...
  vizBuild.forEach((i) => {
    ...
    answer.push([
      ...
      i.name,
      i.name,
      new Date(0, 0, 0, 0, 0, i.startTime),
      new Date(0, 0, 0, 0, 0, i.endingTime),
      null,
      100,
      null,
    ]);
