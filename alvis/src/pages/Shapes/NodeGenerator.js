...
export function connectNodeBTT(circle, circles) {
  ...
  if (circle.leftChild !== null) {
    ...
    circle.id < circle.leftChild
      ? (id = circle.id + "" + circle.leftChild)
      : (id = circle.leftChild + "" + circle.id);
    connections.push(id);
    lines.push({
      id: id,
  ...
  if (circle.rightChild !== null) {
    ...
    circle.id < circle.rightChild
      ? (id = circle.id + "" + circle.rightChild)
      : (id = circle.rightChild + "" + circle.id);
    connections.push(id);
    lines.push({
      id: id,
...
// width of canvas to put circles in
// height of canvas to put circles in
export function generateCirclesGraphing(
  numberCircles,
  canvasWidth,
  canvasHeight
) {
